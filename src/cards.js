...
export const cards = [
  ...
  { id: "nyan-kat-regen", name: "Nyan Kat Regen", type: "spell", cost: 4, abilityText: "Kies rij of kolom en daarna een tegel. Mag geen lijn kiezen die door enemy protected base territory loopt. Enemy units krijgen 200 damage, friendly units 100. Op elk geraakt vakje waar minstens 1 unit damage kreeg spawnt 1 Nyan Kat-token." },
  ...
  { id: "nyan-kat-token", name: "Nyan Kat", type: "unit", role: "token-melee", tags: ["unit", "token", "summon", "melee", "cat"], maxHp: 150, shield: 0, speed: 1, cost: 0, attacks: [attack("melee", 75, 0)], abilityText: "Token van Nyan Kat Regen. Mag samen met gewone units op een vakje staan." },
