...
export const cards = [
  ...
  { id: "junkrat", name: "Junkrat", type: "unit", role: "ranged", tags: ["ranged", "multi-hit"], maxHp: 400, shield: 0, speed: 1, cost: 2, abilityCost: 1, attacks: [attack("ranged", 50, 3)], abilityText: "Passive: afstandsschade. Distance 0 = 50 x5 melee. Distance 1 = 50 x4. Distance 2 = 50 x3. Distance 3 = 50 x1. Ability: Junkrat doet 100 selfdamage en 350 damage op een enemy unit op hetzelfde vakje." },
  ...
  { id: "bomber", name: "Bomber", type: "unit", role: "flying-melee-area", tags: ["flying", "melee", "anti-building", "area-damage"], maxHp: 400, shield: 0, speed: 1, cost: 3, attacks: [attack("melee", 100, 0, { hits: 2, areaRadius: 1 })], abilityText: "Passive: Area Damage op het huidige vakje en alle vakjes binnen range 1. Doet 100 x2 damage en 125 extra damage op gebouwen." },
  ...
  { id: "sigma", name: "Sigma", type: "unit", role: "ranged-area", tags: ["ranged", "area-damage", "barrier"], maxHp: 300, shield: 215, speed: 1, cost: 4, abilityCost: 2, attacks: [attack("ranged", 75, 1, { hits: 2 })], abilityText: "Passive: ranged damage is 75 x2 range 1. Area Damage raakt ook alle enemy units binnen range 1 van het geraakte target voor 50 x2, maar kan die niet los targetten. Ability: Barrier. Plaats binnen range 1 of op Sigma zelf een 700 shield barrier. Activeer opnieuw om de barrier te verwijderen. Als de barrier niet geplaatst is, geneest hij 100 shield per eigen beurt. Als het shield gesloopt wordt, is Sigma hem kwijt." },
  ...
  ,
  { id: "a-10-thunderbolt", name: "A-10 Thunderbolt", type: "unit", role: "flying-ground-attack", tags: ["unit", "flying", "ranged", "ground-attack", "area-damage", "multi-hit"], maxHp: 250, shield: 400, speed: 2, cost: 5, attacks: [attack("BRRRRT", 25, 2, { hits: 10 }), attack("air", 150, 2)], abilityText: "Flying ground-attack unit. Tegen non-flying units, grounded flying units en buildings gebruikt A-10 BRRRRT: 25 x10 damage, range 2, daarna 50 Area Damage binnen range 1 rondom het target. Tegen niet-grounded flying units gebruikt hij Air attack: 150 damage, range 2, zonder Area Damage." }
];
