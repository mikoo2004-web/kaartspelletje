export function renderRulesPage() {
  ...
  root.innerHTML = `
    ...
    <section class="rules-grid">
      ...
      ${ruleCard("Stack Damage en Area Damage", "Stack Damage raakt alle units op één gekozen vakje. Area Damage raakt een gekozen vakje en aangrenzende vakjes, afhankelijk van de kaarttekst. Rij/kolom-effecten volgen hun eigen kaarttekst.")}
      ${ruleCard("Units in gebouwen", "Bij normale buildings krijgt een unit in het gebouw 50% minder damage, naar beneden afgerond. Het gebouw krijgt 100% damage. Bij bunkerShield gebouwen zoals Bunker en Orisa Barrier krijgt de unit 0 damage en krijgt het gebouw alle damage. Kaarttekst gaat altijd boven algemene regels.")}
      ...
      ${ruleCard("Base Pressure", "Aan het begin van je beurt telt hoeveel enemy units in jouw protected base-gebied staan op vakjes waar geen eigen unit staat. Je base verliest 5% van zijn huidige HP per enemy unit. Dit is true damage, maar Base Pressure kan de base niet onder 1 HP brengen. Als de base door normale damage kapot gaat, wint de andere speler.")}
      ...
      ${ruleCard("Voorbeeldbeurt", "1. Je krijgt +3 energie, tot maximaal 10. 2. Klik op Steve. 3. Groene vakjes laten zien waar Steve heen kan. 4. Loop richting de vijand. 5. Staat Steve op hetzelfde vakje als een vijand, dan wordt die rood. 6. Klik om aan te vallen. 7. Klik op Einde beurt en gooi 1 handkaart weg.")}
    </section>
